              ...
              return (
                <div key={log.id} className="relative">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start gap-2">
                    ...
                    <span className="text-[10px] text-muted-foreground font-semibold whitespace-nowrap sm:text-right mt-0.5 shrink-0">
                      {log.timestamp}
                    </span>
                  </div>
                </div>
                    ...
                    <button
                      ...
                      className={`min-w-[28px] h-7 rounded-md text-xs font-semibold transition-colors ${
                        item === safePage
                          ...
                          : 'border border-border bg-card hover:bg-primary-light text-foreground'
                      }`}
                    >
                      {item}
                    </button>
